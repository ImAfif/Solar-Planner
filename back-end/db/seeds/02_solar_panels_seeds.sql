INSERT INTO solar_panel_tech (technology) VALUES ('Crystalline'),
('Thin-Film');

INSERT INTO solar_panels (technology, manufacturer, model, max_power_Wp, max_current_A, max_voltage_V, open_voltage_V, short_circuit_current_A, panel_area, price)
VALUES
...
(1, 'Test Data', 'model1', 210, 6.21, 33.81, 41.59, 7.13, 2, 100),
(1, 'Test Data', 'model2', 350, 10, 32, 39, 8, 2, 150),
(1, 'Test Data', 'model3', 151, 7.9, 18.35, 22.4, 8.5, 2, 85),
(1, 'Test Data','model4', 240, 7.85, 30.6, 37.38, 8.45, 2, 110),
(1, 'Test Data', 'model5', 150, 6.9, 19.35, 21.4, 7.5, 2, 90),
